...
/* harmony export */   "transformEvents": () => (/* binding */ transformEvents)
/* harmony export */ });
...
class Swagger {
  constructor() {
    ...
    _defineProperty(this, "deleteEvent", async eventId => {
      await axios__WEBPACK_IMPORTED_MODULE_0___default().delete(`${this._apiBase}/${eventId}`);
    });
    ...
    _defineProperty(this, "_createDataObj", eventObj => {
